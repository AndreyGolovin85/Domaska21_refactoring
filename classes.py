        ...
        if quantity <= self.get_free_space():
            ...
            if item in self._items:
                ...
                if slots_taken_per_good:
                    ...
                    # Убираем лишний ретурн и переменные
                    #operation_successful = True
                    #return self._items, operation_successful, "Нужное количество товара будет добавлено."
                    return self._items, "Нужное количество товара будет добавлено."
            ...
            return "Недостаточно места для добавления товара. Попробуйте что-то другое."
            ...
            if slots_taken_per_good:
                if quantity <= slots_taken_per_good:
                    ...
                    if slots_taken_per_good == 0:
                        ...
                        return self._items, "Нужное количество товара есть в наличии."
                    ...
                    return "Не хватает товара, попробуйте заказать меньше."
...
# Н#аследуемся от Store олучаем повторение кода
"""
Было
class Shop(Store):
    def __init__(self):
        ...
        if quantity <= self.get_free_space():
            ...
            if item not in self._items:
                if self.get_unique_items_count() >= 5:
                    # Убрать переменную по логике итак False
                    #operation_successful = False
        ...
        if item in self._items:
            ...
            if slots_taken_per_good:
                if quantity <= slots_taken_per_good:
                    ...
                    # Лишний ретурн возвращает тоже самое что и выше
                    #operation_successful = True
                    #return self._items, operation_successful, "Нужное количество товара есть в наличии."
